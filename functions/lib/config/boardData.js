...
exports.TOTAL_BOARD_SPACES = 52;
function getServerSpace(index) {
    const normIndex = ((index % exports.TOTAL_BOARD_SPACES) + exports.TOTAL_BOARD_SPACES) % exports.TOTAL_BOARD_SPACES;
    return exports.SERVER_STANDARD_SPACES[normIndex];
}
